...
const invocationName = "random trivia";
...
const AMAZON_HelpIntent_Handler =  {
    ...
    handle(handlerInput) {
        ...
        let say = 'You can say "one more" to get another random trivia or you can stop the skill with stop and restart'; 
...
const oneMore_Handler =  {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest' && request.intent.name === 'oneMore' ;
    },
